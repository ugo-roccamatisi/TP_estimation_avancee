# Estimation statistique avancée — travaux pratiques

Auteur : Ugo Roccamatisi.

- `tp1` : génération de variables aléatoires, acceptation-rejet et Monte Carlo.
- `tp2a` : régression logistique bayésienne par Metropolis-Hastings.
- `tp2b` : Bayesian LASSO par échantillonnage de Gibbs, avec le PDF de référence.
- `tp3` : modèle LDA et inférence variationnelle, avec le PDF de référence.
